...
body
{
  background-image: url("https://azlyncreative.co.za/wp-content/uploads/2019/06/AdobeStock_177102489-1080x675.jpeg");
...
<nav>
	...
	<div class="logo">
			Smart Events with Best Service</div>
...
<table align="right" border="0">
	...
	<div class="dim">
		<ul>
			...
			<li><a href="../StaffDemo/login.jsp">Staff Login</a></li>
			<hr>
			...
			<hr>
			<li><a href="team.jsp">Event Planners</a></li>
			<hr>
		</ul>
	</div>
	</td>
